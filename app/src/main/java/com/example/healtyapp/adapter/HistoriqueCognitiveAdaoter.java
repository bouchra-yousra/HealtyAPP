...
public class HistoriqueCognitiveAdaoter extends ArrayAdapter<CognitieActivite> {
    ...
    public HistoriqueCognitiveAdaoter(@NonNull Context context, int resource, @NonNull ArrayList<CognitieActivite> liste) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //calories.setText(String.valueOf(getItem(position).()));
